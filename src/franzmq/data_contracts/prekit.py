...
class DataTags(Payload):
    ...
    def version(self) -> str:
        ...
        return hashlib.md5(json.dumps(tags_dict, sort_keys=True).encode()).hexdigest()
...
class DataTagContexts(Payload):
    ...
    def version(self) -> str:
        ...
        return hashlib.md5(json.dumps(contexts_dict, sort_keys=True).encode()).hexdigest()
...
class Computations(Payload):
    ...
    def version(self) -> str:
        ...
        return hashlib.md5(json.dumps(computations_dict, sort_keys=True).encode()).hexdigest()
